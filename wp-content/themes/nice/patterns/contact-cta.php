...
<div class="wp-block-group alignfull nice-contact-band" id="contact">
	...
	<div class="wp-block-group nice-wide nice-contact-band__inner">
		...
		<div class="wp-block-button is-style-nice-primary"><a class="wp-block-button__link wp-element-button" href="#contact-details-pending"><?php esc_html_e( 'WhatsApp', 'nice' ); ?></a></div>
		<!-- /wp:button --><!-- wp:button {"className":"is-style-nice-secondary"} -->
		<div class="wp-block-button is-style-nice-secondary"><a class="wp-block-button__link wp-element-button" href="#contact-details-pending"><?php esc_html_e( 'Email', 'nice' ); ?></a></div>
		<!-- /wp:button --></div>
		<!-- /wp:buttons -->
