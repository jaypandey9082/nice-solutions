 ...
 *
 * Provenance: the outline icons are from Feather (MIT). The WhatsApp, LinkedIn,
 * Instagram and Facebook marks are from Simple Icons (CC0), which are the brand
 * glyphs rather than approximations of them -- a stroked lookalike would
 * misrepresent the mark, and each of these companies publishes rules about how
 * its own mark may be drawn.
 *
 * The social set stops at three because three is what the contact settings can
 * store: nice_get_social_network_labels() names LinkedIn, Instagram and
 * Facebook and nothing else, so a fourth glyph would have no URL to sit beside.
 *
 * @package Nice
 */
